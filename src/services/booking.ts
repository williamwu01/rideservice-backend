...
// Dispatch WhatsApp notifications to all drivers for a pending booking.
// Called after admin approves, or immediately after booking creation.
...
// Atomic accept — first driver wins; rejects if already claimed.
...
// Admin manually assigns a driver, overriding any existing assignment.
